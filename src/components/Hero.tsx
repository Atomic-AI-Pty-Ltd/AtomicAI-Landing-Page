    ...
    >
      <div className="container mx-auto px-6 text-center relative z-10 py-16 md:py-24">
        <motion.h1
          ...
          className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground mb-6 max-w-4xl mx-auto"
        ...
        >
          ...
          >
            <p>
              Stop wasting time in trial and error; we've made the mistakes so
              you don't have to!
            </p>
            <p>
